        ...
        <main class="main"><!--Основной контент сайта-->
            ...
            <article class="articl"><!--Блок который можнобез проблем изъять из контента-->
                <header class="arthed">
                    ...
                    <figure class="artfig"><!-- Блок в который оборачиваем контент, можно заменить дивом-->
                            <img src="img/Hnefatafl/Hnefatafl_1.jpg" alt="brooches_brooches_2" >
                            <figcaption>Настольная игра Хнефатафл с резными краями и Драккарами.</figcaption>
                                <p>
                                Хнефатафл — скандинавская настольная игра. <br>
