...
<body>
        ...
        <article>
            ...
            <div class="main__post">
                ...
                <div class="main__blok_post">
                    ...
                    <div class="btn">
                        <button data-modal class="main__post_button">Read more</button>
                    </div>
                    <hr>
                </div>
            </div>
    ...
    <!-- modal -->
    <!-- <div class="modal_form" id="myModal">
    ...
    <div class="modal">
        <div class="modal__dialog">
            <div class="modal__content">
                <footer class="main__title_post">My First Blog 2021</footer>
                <form action="controller/upload.php"  method="post" enctype="multipart/form-data" name="form-comment">
